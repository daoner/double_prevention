          ...
          <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
            ...
            <SubMenu key="sub4" title={<span><Icon type="insurance" /><span>安全检查与隐患管理</span></span>}>
              <SubMenu key="sub4-1" title="安全检查标准管理">
                <Menu.Item key="sub4-1-1"><Link to="/main/checktable/manage">检查表管理</Link></Menu.Item>
                <Menu.Item key="sub4-1-2"><Link to="/main/firstIndicator/manage">检查内容管理</Link></Menu.Item>
                <Menu.Item key="sub4-1-3"><Link to="/main/secondIndicator/manage">检查标准管理</Link></Menu.Item>
              </SubMenu>
              <Menu.Item key="sub4-2"><Link to="/main/checktable/Input">检查表录入</Link></Menu.Item>
              <Menu.Item key="sub4-3"><Link to="/main/checktable/result">安全检查结果</Link></Menu.Item>
              <Menu.Item key="sub4-4"><Link to="/main/hiddentTrouble/manage">隐患整改信息</Link></Menu.Item>
              <Menu.Item key="sub4-5"><Link to="/main/hiddentTrouble/statistic">隐患分类统计</Link></Menu.Item>
            </SubMenu>
