      ...
      <div>
        <Form layout={formLayout} >
          <Form.Item label="项目名称" {...formItemLayout}>
              ...
              })(<Input maxLength="20" placeholder="双重预防机制管理系统" disabled />)} 
          </Form.Item>
          ...
          <Form.Item label="项目内容" {...formItemLayout}>
            {getFieldDecorator('content', {
              ...
              })(<TextArea style={{maxHeight:"100px"}} maxLength="20" rows={4} placeholder="双重预防机制管理系统的内容" disabled/>)}
          </Form.Item>
          ...
          <Form.Item label="作业地点" {...formItemLayout}>
            ...
            })(<Input placeholder="武汉理工大学余家头校区" disabled/>)}
          </Form.Item>
          ...
          <Form.Item label="主要危险因素" {...formItemLayout}>
            ...
            })(<TextArea rows={4} style={{maxHeight:"100px"}} placeholder="1.自然环境" disabled />)}
          </Form.Item>
          ...
          <Form.Item label="安全措施" {...formItemLayout}>
            ...
            })(<TextArea rows={4} style={{maxHeight:"100px"}} placeholder="1.佩戴安全帽" disabled />)}
          </Form.Item>
          ...
          <Form.Item label="申请人姓名" {...formItemLayout}>
            ...
            })(<Input maxLength="5" placeholder="张某某" disabled />)}
          </Form.Item>
          ...
          <Form.Item label="单位负责人姓名" {...formItemLayout}>
            ...
            })(<Input maxLength="5" placeholder="李某某" disabled />)}
            
          </Form.Item>

          <Form.Item {...buttonItemLayout}>
            <Button style={{float:"right",margin:"0px 20px 0px 0px"}} onClick={()=>{this.props.handleBack()}}>返回</Button>
          </Form.Item>
        </Form>
      </div>
    );
        ...
        return (
            <div className="page">
                ...
                <div className="contentWrap">
                    <ApplyForm assignId={this.props.match.params.id} handleBack={this.handleBack}/>
                </div>
            </div>
        )
    }
